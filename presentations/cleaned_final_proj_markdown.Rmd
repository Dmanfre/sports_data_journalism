...
na_teams <- na_teams %>%
  mutate(ncaa_id = case_when(
    ...
    team.x == "Southern Illinois" ~ "659",
    team.x == "Colorado State" ~ "156",
    team.x == "Nevada-Las Vegas" ~ "466",
    team.x == "Utah State" ~ "731",
    team.x == "Central Connecticut State" ~ "127",
    team.x == "Le Moyne" ~ "349",
    team.x == "Long Island University" ~ "361",
    team.x == "St. Francis (NY)" ~ "599",
    team.x == "Lindenwood" ~ "30136",
    team.x == "Little Rock" ~ "32",
    team.x == "SIU Edwardsville" ~ "660",
    team.x == "Southern Indiana" ~ "661",
    team.x == "Tennessee State" ~ "691",
    team.x == "Tennessee-Martin" ~ "695",
    team.x == "Southern California" ~ "657",
    team.x == "Boston University" ~ "68",
    team.x == "Loyola (MD)" ~ "369",
    team.x == "Louisiana State" ~ "365",
    team.x == "Jackson State" ~ "314",
    team.x == "Prairie View" ~ "553",
    team.x == "Texas A&M-Commerce" ~ "199",
    team.x == "Texas A&M-Corpus Christi" ~ "26172",
    team.x == "St. Thomas" ~ "620",
    team.x == "Arkansas State" ~ "30",
    team.x == "Louisiana-Monroe" ~ "498",
    team.x == "Southern Mississippi" ~ "664",
    team.x == "Tarleton State" ~ "1395",
    team.x == "Texas-Rio Grande Valley" ~ "536",
    team.x == "UT Arlington" ~ "702",
    team.x == "Pacific" ~ "2751",

...
```
I noticed Tennessee won 12-of-13 games from Dec. 6 to Jan. 22. The codeblock below shows that Tennessee had a 1.7 ator in those 12. wins. Not quite a 2:1 but still pretty good all things considered because the avg_ator of everyone during that stretch of time was 0.94.
```{r}
...
#getting average ator for the streak

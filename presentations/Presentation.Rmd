...
```{r}
ggplot() +
  geom_point(data = ator_only, aes(x = total_wins, y = avg_ator), alpha = 0.2) +
  geom_point(data = b10, aes(x = total_wins, y = avg_ator), color = "red") +
  geom_smooth(data=ator_only, aes(x=total_wins, y=avg_ator), method="lm") +
...
In this bubble plot, I thought the SEC was interesting comparison, because like the Big Ten, its teams are spread around, but Tennessee stood out to me becasue of its placement. SEC teams seem to have a higher win count but lower ator.

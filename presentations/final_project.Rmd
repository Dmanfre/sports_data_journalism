...
Analysis: `Austraulia had the third most players in 23-24 but its down 23 players from a seaosn ago. Spain on the other hand, gained 24 new players.`
```{r}
...
# joining
total_country <- inner_join(countries, countries_22_23, by = "country_clean")

...
joined_home_team_ator is a dataframe showing the numebr of wins and the home team's avg ator for the seaosn. 
```{r}
...
Doing a scatter plot that highlights the big ten teams
```{r}

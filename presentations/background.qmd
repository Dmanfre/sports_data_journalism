...
```{r}
# The average team astor is 0.9845934. I will use this number to base my filter
# The average opp astor is 0.9550222. I will use this number to base my filter of the opponents.
average_astors <- astor_pergame %>%
  summarize(Average_Team_AToR = mean(Team_AToR),
            Average_oppAToR = mean(Opp_AToR))

astor_pergame %>% 
filter(Team_AToR >= 0.9)
#3,605 games resulted in wins with teams that had an astor over 0.9.
```
From there, I can identify a team's percentage of wins

I wanto to identify the average astor's in wins and loses.
Also curious to see what team had the most games with an above average astor.
